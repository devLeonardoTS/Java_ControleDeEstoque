...
public final class AppConfig {
    ...
    public final static String DEFAULT_PRODUCT_IMG_FILE = "default_product_img.png";
    public final static String DEFAULT_COMPANY_LOGO_FILE = "default_company_logo.png";
